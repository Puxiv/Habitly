...
@MainActor @Observable final class LanguageManager {
    ...
    var moduleNotes: Bool {
        didSet { UserDefaults.standard.set(moduleNotes, forKey: "module_stuff") }
    }
...
extension LanguageManager {
    ...
    var notifOffTitle:   String { t("Notifications Off 🔕",
                                    ...
                                    "Известията са изключени 🔕",
                                    "Известията са изключени 🔕") }
    var notifOffMessage: String { t("Head to Settings → GrogyBot to turn on notifications.",
                                    "Отиди в Настройки → GrogyBot, за да включиш известията.",
                                    "Иди в Наредби → GrogyBot да ги пуснеш.",
                                    "Иди у Настройки → GrogyBot да ги пуснеш.",
                                    "Иди в Настройки → GrogyBot да ги пуснеш бе.",
                                    "Иди в Настройки → GrogyBot да ги пуснеш де.") }
    ...
    var notesTab:      String { t("Notes",     "Бележки",     "Бележки",     "Бележки",      "Бележки",      "Бележки") }
    ...
    var dashNotesTitle:     String { t("Notes",      "Бележки",    "Бележки",    "Бележки",    "Бележки",    "Бележки") }
    ...
    func dashNotesCount(_ n: Int) -> String {
        t("\(n) notes", "\(n) бележки", "\(n) бележки", "\(n) бележки", "\(n) бележки", "\(n) бележки")
    }
    ...
    var dashNoNotesYet:     String { t("No notes yet",      "Все още нямаш бележки", "Нема бележки още",      "Нема бележки още",      "Нема бележки още бе",     "Нема бележки още батка") }
    ...
    // MARK: Notes
    var newNoteTitle:  String { t("New Note ✏️",  "Нова бележка ✏️", "Нова бележка ✏️", "Нова бележка ✏️", "Нова бележка ✏️", "Нова бележка ✏️") }
    var editNoteTitle: String { t("Edit Note ✏️", "Редактирай ✏️",   "Оправи го ✏️",     "Оправи го ✏️",     "Оправи го ✏️",    "Оправи го ✏️") }

    var noteTitlePlaceholder: String { t("Title",
                                          "Заглавие",
                                          "Заглавие",
                                          "Заглавие",
                                          "Заглавие",
                                          "Заглавие") }
    var noteBodyPlaceholder:  String { t("Start typing…",
                                          "Започни да пишеш…",
                                          "Почни да пишеш…",
                                          "Почни да пишеш…",
                                          "Почни да пишеш бе…",
    ...
    var noteArchive:      String { t("Archive",       "Архивирай",     "Архивирай",     "Архивирай",     "Архивирай",     "Архивирай") }
    var noteUnarchive:    String { t("Unarchive",     "Извади",        "Извади",        "Извади",        "Извади",        "Извади") }
    var noteShowArchived: String { t("Show Archived", "Покажи архива", "Покажи архива", "Покажи архива", "Покажи архива", "Покажи архива") }
    var noteHideArchived: String { t("Hide Archived", "Скрий архива",  "Скрий архива",  "Скрий архива",  "Скрий архива",  "Скрий архива") }

    var notePin:      String { t("Pin",       "Закачи",     "Закачи",     "Закачи",     "Закачи",     "Закачи") }
    var noteUnpin:    String { t("Unpin",     "Откачи",     "Откачи",     "Откачи",     "Откачи",     "Откачи") }
    var notesPinned:  String { t("Pinned",    "Закачени",   "Закачени",   "Закачени",   "Закачени",   "Закачени") }

    var sortByDate:     String { t("By Date",     "По дата",      "По дата",      "По дата",      "По дата",      "По дата") }
    var sortByTitle:    String { t("By Title",    "По заглавие",  "По заглавие",  "По заглавие",  "По заглавие",  "По заглавие") }

    var emptyNotesTitle:    String { t("No notes yet! 📝",
                                        "Все още нямаш бележки! 📝",
                                        "Па тука нема бележки! 📝",
                                        "Епа нема бележки туке! 📝",
                                        "Майна, нема бележки тука! 📝",
                                        "Ей, нема бележки тука! 📝") }
    var emptyNotesSubtitle: String { t("Write your first note — ideas, lists, anything! 💡",
                                        "Напиши първата си бележка — идеи, списъци, всичко! 💡",
                                        "Тури бележка — идеи, списъци, шо ти треа 💡",
                                        "Тури бележка — идеи, списъци, шо ти треа 💡",
                                        "Тури бележка — идеи, списъци, кво ти трябва 💡",
                                        "Тури бележка — идеи, списъци, кво ти трябва 💡") }
    var createFirstNote:    String { t("Create my first note",
                                        "Създай първата бележка",
                                        "Тури бележка",
                                        "Тури бележка",
                                        "Тури бележка бе",
                                        "Тури бележка") }
